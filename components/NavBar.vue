<template>
    ...
    >
        ...
        >
            <div
                class="
                    flex flex-col items-center justify-center border-b py-3
                    lg:flex-row
                "
                :class="!navbar.transparent ? 'border-contrast/10' : 'border-transparent'"
            >
                <div
                    class="
                ...
                >
                    ...
                    <button
                        class="
                            ...
                            lg:hidden
                        "
                        :class="{ 'text-red-600': navbar.open }"
                        @click="navbar.toggle()"
                    >
                        <div
                            class="
                                absolute top-1/2 left-1/2 block w-6 -translate-x-1/2
                                -translate-y-1/2
                            "
                        >
                            <span
                                aria-hidden="true"
                                class="
                                    absolute block h-0.5 w-6 bg-current transition duration-300
                                    ease-in-out
                                "
                ...
                <div
                    class="
                        flex h-0 w-full flex-col items-center overflow-hidden transition-all
                        duration-500
                        lg:h-auto lg:flex-row lg:overflow-visible
                    "
                ...
                >
                    ...
                    <ul
                        class="
                            my-auto flex flex-col gap-6
                            sm:flex-row
                            lg:ml-auto
                        "
                    >
                        <li
                            v-for="value, key in navbar.links"
                            :key="key"
                            anime
                        >
                            <a
